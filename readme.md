...
- ## Manual
    - ### Dependancies
        #### Arch
        > ```sh
        > paru -S hyprland-git foot grim hyprpaper fish theme.sh sassc starship cava imagemagick gnome-bluetooth wl-clipboard libdbusmenu-gtk3 gnome-bluetooth-3.0 xorg-xrandr nerd-fonts cpio cmake git meson gcc
        > ```
        #### STTT
