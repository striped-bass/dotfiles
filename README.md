...
- ## Manual
    - ### Dependancies
        #### Arch
        > ```sh
        > paru -S hyprland hyprlauncher hyprlock hypridle hyprpolkitagent hyprshade foot grim fish theme.sh sassc starship ttf-ibmplex-mono-nerd imagemagick gnome-bluetooth wl-clipboard libdbusmenu-gtk3 gnome-bluetooth-3.0 xorg-xrandr unimatrix aylurs-gtk-shell cpio cmake git meson gcc stow
        > ```
        #### STTT
